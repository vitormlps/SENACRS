...
class FGTS(Base):
    ...
    entidade_responsavel: Mapped[str] = mapped_column(nullable=False)
    unidade_inscricao: Mapped[str] = mapped_column(nullable=False)
    ...
    receita_principal: Mapped[str] = mapped_column(nullable=False)
